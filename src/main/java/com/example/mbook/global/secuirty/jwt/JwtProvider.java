package com.example.mbook.global.secuirty.jwt;
...
import com.example.mbook.global.secuirty.jwt.repository.RefreshTokenRepository;
...
public class JwtProvider {
    ...
    public Authentication getAuthentication(String token) {
        ...
        if (claims.get("roles") == null) {
            throw new IllegalStateException("Role Not Found Exception");
        }
    ...
    public boolean validateToken(String jwtToken) {
        try {
            ...
            throw new IllegalStateException("Token 만료");
        } catch (Exception e) {
            throw new IllegalStateException("Token 만료");
        }
    }
    ...
    public TokenResponse reissueAtk(UserResponse userResponse) {
        boolean rtkInRedis = refreshTokenRepository.existsByEmail(userResponse.getEmail());
        if (rtkInRedis) throw new IllegalStateException("Token 만료");
