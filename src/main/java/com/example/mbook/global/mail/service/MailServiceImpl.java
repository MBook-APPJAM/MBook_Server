...
public class MailServiceImpl implements MailService{
    ...
    public String randomMessage(String nickName) {
    ...
    @Override
    public void mailSend(MailRequest request, String nickName)throws Exception{
        MimeMessage message = javaMailSender.createMimeMessage();

        message.addRecipients(MimeMessage.RecipientType.TO,request.getEmail()); // 보내는 대상
        message.setSubject("'엠북(MBook)' 인증 코드" );
        ...
        msgg+= "<div class=\"\"><div class=\"aHl\"></div><div id=\":2j\" tabindex=\"-1\"></div><div id=\":2q\" class=\"ii gt\" jslog=\"20277; u014N:xr6bB; 4:W251bGwsbnVsbCxbXV0.\"><div id=\":1l\" class=\"a3s aiL \"><div class=\"adM\">\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t<td style=\"color:#999\">\n" +
                "\t\t\t\t\t\t\t\t\t\t\t<p style=\"margin:20px 0;padding:0\"><strong style=\"color:#333\">안녕하세요. <em style=\"color:#6C1FD3;font-style:normal\">엠북</em> 입니다.</strong></p>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t<p style=\"margin:20px 0;padding:0\">" + nickName +"님이 신청하신 서비스는 본인확인을 위해 <span class=\"il\">인증</span><span class=\"il\">번호</span> 확인이 필요합니다. <br>아래의 <span class=\"il\">인증</span><span class=\"il\">번호</span>를 복사하신 후 이메일 <span class=\"il\">인증</span><span class=\"il\">번호</span> 입력란에 입력해 주시기 바랍니다. <br><span class=\"il\"></p>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t<span><strong style=\"color:#000;font-weight:bold;font-size:30px;\">" + randomMessage(nickName) + "</strong></span>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t</div>\n" +
                "\t\t\t\t\t\t\t\t\t\t\t<p style=\"margin:20px 0;padding:0\"><strong style=\"color:#333\">엠북을 이용해 주셔서 감사합니다.</strong></p>\n" +
                "\t\t\t\t\t\t\t\t\t\t</td>\n" +
                "\t\t\t\t\t\t\t\t\t\t<td width=\"40\" style=\"color:#999\"></td>\n" +
                "\t\t\t\t\t\t\t\t\t</tr>\n" +
                "\t\t\t\t\t\t\t\t\t<tr>\n" +
                ...
                "\t\t\t\t\t\t\t\t\t\t\t\t잘못 수신된 메일이라면 hoyoung7827@gmail.com에 문의해주시길 바랍니다.\n" +
                "\t\t\t\t\t\t\t\t\t\t\t</p>\n" +
        ...
        message.setFrom(new InternetAddress("hoyoung7827@gmail.com","엠북"));//보내는 사람
